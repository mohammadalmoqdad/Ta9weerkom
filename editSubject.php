...
$query2=mysqli_query($idd,"select * from price_list  where ID_Photographer='$id' And ID_Subject='$subject' AND ID_Mode='$mode' AND Id_Unit='$unit' ");
...
$Q=mysqli_query($idd,"UPDATE `price_list` SET  `Price`='$price' WHERE `ID_Photographer`='$id'  And ID_Subject='$subject' AND ID_Mode='$mode' AND Id_Unit='$unit'");
}
if ($rows!=1) {
 echo"  <script>alert('This Subject details is not exist')</script>";
}
...
<html>
  ...
  <body>
    ...
    <form  action="editSubject.php" method="post" >
        <div class="banner">
          <h1>Here you can edit your Subjects details</h1>
        </div>
